...
create table CIUDADANO (
    ...
    ESTADO_VACUNACION VARCHAR (50) NOT NULL,
    REGION VARCHAR (20) NOT NULL,
    DESEA_SER_VACUNADO NUMBER(1) NOT NULL CHECK  (DESEA_SER_VACUNADO in (0,1)),
    PLAN_DE_VACUNACION NUMBER (6,0) NOT NULL,
    PUNTO_VACUNACION NUMBER (6,0) NOT NULL,
    OFICINA_REGIONAL_ASIGNADA NUMBER (6,0)
);
...
create table USUARIO (
    ...
    PLAN_DE_VACUNACION NUMBER (6,0) NOT NULL,
    CIUDADANO NUMBER (20,0) NOT NULL
);


--PLAN_DE_VACUNACION
create table PLAN_DE_VACUNACION (
    ID_PLAN_DE_VACUNACION NUMBER (6,0),
...
create table PUNTO_VACUNACION (
    ID_PUNTO_VACUNACION NUMBER (6,0),
    LOCALIZACION NUMBER (6,0) NOT NULL,
    CAPACIDAD_DE_ATENCION_SIMULTANEA NUMBER (6,0) NOT NULL,
    CAPACIDAD_DE_ATENCION_TOTAL_DIARIA NUMBER (6,0) NOT NULL,
...
create table CITA (
    ID_CITA NUMBER (6,0),
    FECHA DATE NOT NULL,
    CIUDADANO NUMBER (6,0) NOT NULL,
    PUNTO_VACUNACION NUMBER (6,0) NOT NULL,
    VACUNA NUMBER (6,0) NOT NULL
);
...
INSERT INTO TRABAJO (TRABAJOS) VALUES ('Administrador punto de vacunacion');
INSERT INTO TRABAJO (TRABAJOS) VALUES ('Operador punto de vacunacion');
